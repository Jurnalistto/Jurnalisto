            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
              {displayNews[0] && (
                <article className="lg:col-span-2 group">
                  <Link href={`/berita/${displayNews[0].slug}`} className="block">
                    <div className="relative h-56 sm:h-72 lg:h-80 rounded-xl overflow-hidden">
                      <Image
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                        <span className="px-2 py-1 bg-white/20 backdrop-blur-sm text-white text-[10px] sm:text-xs font-semibold rounded mb-2 inline-block">
                          {displayNews[0].kategori}
                        </span>
                        <h2 className="font-serif text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 group-hover:text-gray-200 transition-colors">
                          {displayNews[0].title}
                        </h2>
              ...
              <div className="flex flex-col gap-4">
                {displayNews.slice(1, 4).map((berita) => (
                  <article key={berita.id} className="group bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow flex-1">
                    <Link href={`/berita/${berita.slug}`} className="flex h-full">
                      <div className="relative w-24 sm:w-32 h-auto sm:h-full min-h-[80px]">
                        <Image
                          src={berita.gambar}
                          alt={berita.title}
                          fill
                      ...
                      <div className="p-2 sm:p-3 flex flex-col justify-center flex-1">
                        ...
                        <h3 className="font-serif text-xs sm:text-sm font-bold text-gray-900 line-clamp-2 group-hover:text-red-600 transition-colors mt-1">
                          {berita.title}
                        </h3>
